# Generated by Powerlevel10k configuration wizard on 2022-02-05 at 23:31 CST.
...
function base16 {
  local color_index="${(l:2::0:)1}"
  local fallback="${2:-$1}"

  if zstyle -b :base16 available _; then
  	zstyle -s :base16:colors base"$color_index" color
  	printf "%s" "$color"
  else
  	printf "%s" "$fallback"
  fi
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND=$(base16 0D 4)
  # Default current directory foreground color.
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=$(base16 00 254)
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=$(base16 03 250)
  # Color of the anchor directory segments. Anchor segments are never shortened. The first
  # segment is always an anchor.
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=$(base16 00 255)
